  ...
  function userData() {
    $.ajax({
      ...
      success: function (data) {
        ...
        const result = ageList.reduce((acc, item) => {
          const type = item.studentGrade === null ? 'teacher' : 'student';
        ...
        const typeCtx = document.getElementById('member-type-count').getContext('2d');
        const myChart = new Chart(typeCtx, {
          type: 'doughnut', // 도넛형 차트
          data: {
            labels: ['Teacher', 'Student'],
            datasets: [{
              data: [result.teacher, result.student],
              backgroundColor: ['#FF6384', '#36A2EB'], // 각 데이터의 색상
              hoverBackgroundColor: ['#FF6384', '#36A2EB'] // 각 데이터의 hover 색상
            }]
          },
          options: {
            responsive: true,
            ...
            lectureChart = new Chart(ctx, {
              ...
              data: {
                ...
                datasets: [{
                  ...
                  data: createCount, // Y축에 표시될 수업 개설 수
                  backgroundColor: 'rgba(75, 112, 192, 1)', // 막대의 배경색
                  borderColor: 'rgba(75, 192, 192, 1)', // 막대의 경계선 색
                  borderWidth: 1 // 경계선의 두께
                }]
              },
