...
, function(e, t, n) {
    ...
    Litepicker.add("keyboardnav", {
        init: function(e) {
            ...
            function i(t) {
                e.isMouseDown ? e.isMouseDown = !1 : this.options.inlineMode || this.isShowning() || (this.show(t.target),
                this.ui.querySelector('[tabindex="'.concat(e.options.keyboardnav.firstTabIndex, '"]')).focus())
            }
            function a(e) {
                var t = this;
            ...
            e.ui.addEventListener("keydown", function(r) {
                var o = this
                  , i = r.target;
                ...
                case "Space":
                    !function(t, n) {
                        t.classList.contains("day-item") && (n.preventDefault(),
            ...
            .bind(e), !0);
            var c = e.options;
            c.element instanceof HTMLElement && (c.element.addEventListener("mousedown", r.bind(e), !0),
            c.element.addEventListener("focus", i.bind(e), !0)),
            c.elementEnd instanceof HTMLElement && (c.elementEnd.addEventListener("mousedown", r.bind(e), !0),
    ...
    e.exports = function(e) {
        ...
        n.i = function(e, t, r) {
            ...
            for (var s = 0; s < e.length; s++) {
                var c = [].concat(e[s]);
                r && a[c[0]] || (t && (c[2] ? c[2] = "".concat(t, " and ").concat(c[2]) : c[2] = t),
                n.push(c))
            }
        }
        ,
    ...
    Litepicker.add("ranges", {
        init: function(e) {
            ...
            if (!Object.keys(t.customRanges).length) {
                var r, i = e.DateTime();
                t.customRanges = (o(r = {}, t.customRangesLabels[0], [i.clone(), i.clone()]),
                ...
                o(r, t.customRangesLabels[4], function(e) {
                    var n = e.clone();
                    return n.setDate(1),
                    [n, new Date(e.getFullYear(),e.getMonth() + 1,0)]
                }(i)),
                o(r, t.customRangesLabels[5], function(e) {
                    var n = e.clone();
                    return n.setDate(1),
                ...
                Object.keys(t.customRanges).forEach((function(a) {
                    ...
                    i.addEventListener("click", (function(n) {
                        ...
                        if (r) {
                            ...
                            t.autoApply ? (e.setDateRange(a, o, t.force),
                            e.emit("ranges.selected", a, o),
                            e.hide()) : (e.datePicked = [a, o],
...
, function(e, n, t) {
    ...
    var a = {
        insert: function(e) {
            ...
            window.disableLitepickerStyles || (t ? t.nextSibling ? n.insertBefore(e, t.nextSibling) : n.appendChild(e) : n.insertBefore(e, n.firstChild),
            window._lastElementInsertedByStyleLoader = e)
        },
        singleton: !1
    };
...
, function(e, t, n) {
    ...
    function a(e, t) {
        for (var n = [], r = {}, i = 0; i < e.length; i++) {
            ...
            r[l] ? r[l].parts.push(a) : n.push(r[l] = {
                id: l,
                parts: [a]
            })
        }
        ...
        init: function(e) {
            ...
            e.on("before:click", (function(n) {
                if (n.classList.contains("day-item")) {
                    ...
                    n.classList.contains("is-selected") ? (e.preMultipleDates = e.preMultipleDates.filter((function(e) {
                        return e !== r
                    }
                    )),
                    e.emit("multiselect.deselect", e.DateTime(r))) : (e.preMultipleDates[e.preMultipleDates.length] = r,
            ...
            e.multipleDatesToString = function() {
                ...
                return e.multipleDates.map((function(n) {
